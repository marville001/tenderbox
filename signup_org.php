...
<div class="container">
  ...
  <div class="wrapper">
    <section class="form signup">
      <header>
        ...
        <h2><a href="signup_supplier.php">Supplier</a></h2>
      </header>
      <h3 style="text-align: center;">Organization Register</h3>
      ...
      <div class="link">Already signed up? <a href="login_org.php">Login now</a></div>
    </section>
  </div>
  </div>
  ...
  <script>
      ...
      continueBtn.onclick = () => {
        ...
        xhr.open("POST", "utils/signup_org.php", true);
        xhr.onload = () => {
